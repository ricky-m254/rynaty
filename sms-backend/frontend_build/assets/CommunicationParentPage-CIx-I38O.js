...
St. Mary's Nairobi High School`},{key:"attendance-alert",label:"Attendance Alert",description:"Alert parents when a student has been recorded absent or late.",icon:E,color:"amber",gradient:"from-amber-500/20 via-amber-500/5 to-transparent",border:"border-amber-500/25",badgeBg:"bg-amber-500/10",badgeColor:"text-amber-400",endpoint:"/communication/parent/attendance-alert/",defaultSubject:"Attendance Alert — St. Mary's Nairobi High School",defaultMessage:`Dear Parent/Guardian,
...
St. Mary's Nairobi High School`},{key:"meeting-invite",label:"Meeting Invitation",description:"Send invitations to parents for scheduled meetings or events.",icon:H,color:"cyan",gradient:"from-cyan-500/20 via-cyan-500/5 to-transparent",border:"border-cyan-500/25",badgeBg:"bg-cyan-500/10",badgeColor:"text-cyan-400",endpoint:"/communication/parent/meeting-invite/",defaultSubject:"Parents' Meeting Invitation — St. Mary's Nairobi High School",defaultMessage:`Dear Parent/Guardian,
