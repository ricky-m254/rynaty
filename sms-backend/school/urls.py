...
from .views import (
    ...
    FeesBulkImportView, PaymentsBulkImportView,
    ...
    ControlPlaneSummaryView, SecurityPolicyView, SessionTimeoutSettingsView,
...
urlpatterns = [
    ...
    path('settings/session-timeout/', SessionTimeoutSettingsView.as_view(), name='settings_session_timeout'),
    ...
    path('settings/import/fees/',           FeesBulkImportView.as_view(),           name='fees_bulk_import'),
    path('settings/import/payments/',       PaymentsBulkImportView.as_view(),       name='payments_bulk_import'),
